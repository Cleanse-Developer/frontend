    ...
    <div className="blogpost-page">
      ...
      <section className="blogpost-body">
        <article className="blogpost-article">
          {/* The excerpt already exists per post and is what the index card shows,
              so it doubles as the summary here — no second field for anyone to
              write or keep in sync. Hidden rather than faked if a post has none. */}
          {blog.excerpt && <p className="blogpost-summary">{blog.excerpt}</p>}
